...
//                ticks: { beginAtZero: true, color: coreui.Utils.getStyle("--cui-text-disabled"), font: { size: 14 }, maxTicksLimit: 5, padding: 16, stepSize: Math.ceil(100 / 4) },
//            },
//        },
//    },
//});
...
//                borderWidth: 3, data: [78, 81, 80, 45, 34, 22, 40,50,60,70,80,90],
//                fill: true
//            },
//        ],
//    },
...
const cardChart1 = new Chart(document.getElementById("card-chart1"), {
    ...
    data: {
        ...
        datasets: [{ label: "My First dataset", backgroundColor: "transparent", borderColor: "rgba(255,255,255,.55)", pointBackgroundColor: coreui.Utils.getStyle("--cui-primary"), data: [65, 59, 84, 84, 51, 55, 40] }],
    },
    options: {
        plugins: { legend: { display: false } },
        maintainAspectRatio: false,
        scales: { x: { grid: { display: false, drawBorder: false }, ticks: { display: false } }, y: { min: 30, max: 89, display: false, grid: { display: false }, ticks: { display: false } } },
...
const cardChart3 = new Chart(document.getElementById("card-chart3"), {
    ...
    data: {
        labels: ["January", "February", "March", "April", "May", "June", "July"],
        datasets: [{ label: "My First dataset", backgroundColor: "rgba(255,255,255,.2)", borderColor: "rgba(255,255,255,.55)", data: [78, 81, 80, 45, 34, 12, 40], fill: true }],
    },
    options: {
        plugins: { legend: { display: false } },
        maintainAspectRatio: false,
...
const cardChart4 = new Chart(document.getElementById("card-chart4"), {
    ...
    data: {
        ...
        datasets: [{ label: "My First dataset", backgroundColor: "rgba(255,255,255,.2)", borderColor: "rgba(255,255,255,.55)", data: [78, 81, 80, 45, 34, 12, 40, 85, 65, 23, 12, 98, 34, 84, 67, 82], barPercentage: 0.6 }],
    },
    options: {
        maintainAspectRatio: false,
        plugins: { legend: { display: false } },
        scales: { x: { grid: { display: false, drawTicks: false }, ticks: { display: false } }, y: { grid: { display: false, drawBorder: false, drawTicks: false }, ticks: { display: false } } },
    },
});
