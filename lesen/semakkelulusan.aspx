<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="VB" MasterPageFile="~/MasterMenu.master" AutoEventWireup="false" CodeFile="semakkelulusan.aspx.vb" Inherits="kelulusan" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
                        ...
                        <asp:Panel ID="pnlSuratAuto" runat="server">
                            ...
                            <div class="row" hidden="hidden">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label>Isi Kandungan Sekunder (Seksyen atas)</label>
                            ...
                            <div class="row" hidden="hidden">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        <label>Isi Kandungan Sekunder (Seksyen bawah)</label>
                                        <asp:TextBox ID="EditorSurat3" runat="server" Text="" TextMode="MultiLine" Rows="10" CssClass="form-control"></asp:TextBox>
                                        <asp:HtmlEditorExtender ID="HtmlEditorExtender3" runat="server" TargetControlID="EditorSurat3" DisplaySourceTab="True">
                                            <%--<Toolbar>
                                                <ajaxToolkit:Undo />
                                                <ajaxToolkit:Redo />
                                                <ajaxToolkit:Bold />
                            ...
                            <div class="row" hidden="hidden">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="EditorSurat4" runat="server" Text="" TextMode="MultiLine" Rows="10" CssClass="form-control"></asp:TextBox>
                                        <asp:HtmlEditorExtender ID="HtmlEditorExtender4" runat="server" TargetControlID="EditorSurat4" DisplaySourceTab="True">
                                            <%--<Toolbar>
                                                <ajaxToolkit:Undo />
                                                <ajaxToolkit:Redo />
                                                <ajaxToolkit:Bold />
            ...
            <div class="card" runat="server" id="idListing">
                <div class="card-body" style="overflow-x: auto;">
                    ...
                    <asp:GridView ID="GridView1" runat="server" Visible="true" AllowPaging="true"
                        ...
                        DataKeyNames="Permohonan_ID,StatusID,JenisLesen_ID,IsSuratKelulusanFail,IsPublish"
    ...
    <asp:SqlDataSource ID="SqlDataSourceGrid" runat="server"
        ...
        SelectCommand="SELECT ROW_NUMBER() OVER(ORDER BY TarikhMohon desc, Permohonan_ID desc) as RowNo, * FROM (
            ...
            @AgensiID AS UserType, a.*, d.JenisLesen_Description, g.Rujukan, g.IsSuratKelulusanFail, g.StatusID, g.IsPublish, g.Is24jam, f.Pemohon_Name, h.CreatedDt FROM 
            v_LESEN_ApprovalList_Curr a
            inner join LESEN_JenisLesen d on d.JenisLesen_ID = a.JenisLesen_ID
        ...
        <DeleteParameters>
            <asp:ControlParameter ControlID="GridView1" DefaultValue="" Name="JenisLesen_ID" PropertyName="SelectedDataKey.Values[2]" />
        </DeleteParameters>
