<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="VB" MasterPageFile="~/MasterMenu.master" AutoEventWireup="false" CodeFile="semakansurat.aspx.vb" Inherits="semakansurat" %>
        ...
        <div class="card" runat="server" id="idListing">
                <div class="card-body" style="overflow-x: auto;">
                    ...
                    <asp:GridView ID="GridView1" runat="server"
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="PermohonanAgensi_ID,JenisLesen_ID,jenisPermohonan,JabatanAgensi_Type,Permohonan_ID"
...
select
a.Permohonan_ID,'Permohonan Baru' as jenisPermohonan,PermohonanAgensi_ID,b.JenisLesen_ID,TarikhMohon,
JenisLesen_Description,Pemohon_Name,JabatanAgensi_Description,Permohonan_PemohonID,Rujukan,JabatanAgensi_Type,NamaSyarikat
from LESEN_PermohonanAgensi a
inner join LESEN_Permohonan b on b.Permohonan_ID = a.Permohonan_ID
inner join LESEN_JabatanAgensi c on c.JabatanAgensi_ID = a.JabatanAgensi_ID
inner join LESEN_JenisLesen d on d.JenisLesen_ID = b.JenisLesen_ID
...
and JenisLesen_ID = case when @lesenID = 0 then JenisLesen_ID else @lesenID end
