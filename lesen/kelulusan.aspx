<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="VB" MasterPageFile="~/MasterMenu.master" AutoEventWireup="false" CodeFile="kelulusan.aspx.vb" Inherits="kelulusan" %>
                    ...
                    <div class="info-card-header">
                        <div class="info-card-header-left">
                            ...
                            <div>
                                ...
                                <div class="sub-text"><asp:Label ID="Label3" runat="server" Text='<%# Bind("JenisLesen_Description") %>'></asp:Label></div>
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div>
                                ...
                                <div class="info-value"><asp:Label ID="Label3b" runat="server" Text='<%# Bind("JenisLesen_Description") %>'></asp:Label></div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_SaizIklan" runat="server" CssClass="form-control" />
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_UnitIklan" runat="server" TextMode="Number" CssClass="form-control" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DDL_AnjingBaka" CssClass="form-control select2" runat="server"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_AnjingJantan" runat="server" TextMode="Number" CssClass="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_AnjingBetina" runat="server" TextMode="Number" CssClass="form-control" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_AnjingJantanMandul" runat="server" TextMode="Number" CssClass="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_AnjingBetinaMandul" runat="server" TextMode="Number" CssClass="form-control" />
...
<%--            <div class="ulasan-footer-card">
            ...
            <div class="card" runat="server" id="idListing">
                <div class="card-body" style="overflow-x: auto;">
                    ...
                    <asp:GridView ID="GridView1" runat="server"
                        AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Permohonan_ID,AgensiID,ApprStatusID,JabatanAgensi_Type,JenisLesen_ID,IsSuratPemeriksaanFail,IsPenilaianStatus"
    ...
    <asp:SqlDataSource ID="SqlDataSourceGrid" runat="server"
        ConnectionString="<%$ ConnectionStrings:webcon_ConnectionStr %>"
        SelectCommand="SELECT g.NamaSyarikat,a.*,d.*,e.*,f.*, g.Rujukan,g.IsSuratPemeriksaanFail,ISNULL(g.AlamatBaru,ISNULL(g.AlamatPremis,ISNULL(g.AlamatPenjajaan,ISNULL(g.AnjingAlamat,isnull(g.LokasiPasar1,ISNULL(g.LokasiPasar2,ISNULL(g.LokasiPasar3,''))))))) as AlamatPremis, isnull(h.IsPenilaian,0) as IsPenilaianStatus FROM
            v_LESEN_ApprovalList_Curr a
            inner join LESEN_JenisLesen d on d.JenisLesen_ID = a.JenisLesen_ID
            left join LESEN_JabatanAgensi e on e.JabatanAgensi_ID = a.AgensiID
            inner join LESEN_Pemohon f on f.Pemohon_ID = a.Permohonan_PemohonID
