        ...
        Using myConnection As New SqlConnection(ConfigurationManager.ConnectionStrings("webcon_ConnectionStr").ConnectionString)
            ...
            Try
                If myReader.Read Then
                    ...
                    EditorSurat1.Text = myReader.Item("SuratKelulusan1").ToString
                    EditorSurat2.Text = myReader.Item("SuratKelulusan2").ToString
                    EditorSurat3.Text = myReader.Item("SuratKelulusan3").ToString
                    EditorSurat4.Text = myReader.Item("SuratKelulusan4").ToString
