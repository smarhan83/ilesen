                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField ShowHeader="False">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:LinkButton runat="server" CommandName="Delete" Visible="True" CssClass="btn btn-default btn-sm" CommandArgument='<%# Container.DataItemIndex %>' OnClientClick="return confirm('Padam pilihan ini?');" data-toggle="tooltip" data-placement="top" title="Delete" CausesValidation="False" ID="LinkButton2">Padam</asp:LinkButton>
