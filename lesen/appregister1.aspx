                            ...
                            <asp:GridView ID="GridView1" HeaderStyle-ForeColor="Black" CssClass="table table-bordered" AllowPaging="True" PageSize="20"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" CssClass="btn btn-primary btn-sm" CausesValidation="False" ID="LinkButton6" data-toggle="tooltip" data-placement="top" title="Send" Text="Hantar" Visible='<%# If(Eval("Description") = "Draf (Telah Disemak)", True, False) %>' OnCommand="OnClickBtnSubmit" OnClientClick="return confirm('Hantar ke jabatan agensi sekarang?');"/> 
