...
Partial Class apptype
    ...
    Private Sub fvBayaran_ItemInserted(sender As Object, e As FormViewInsertedEventArgs) Handles fvBayaran.ItemInserted
        gvBayaran.DataBind()
    End Sub
    ...
    Private Sub FormViewReportSKL_ItemUpdated(sender As Object, e As FormViewUpdatedEventArgs) Handles FormViewReport.ItemUpdated
        ShowAlert("success", "", "Rekod berjaya dikemaskini")
        GridViewReport.DataBind()
    End Sub
    ...
    Private Sub FormView3_ItemUpdated(sender As Object, e As FormViewUpdatedEventArgs) Handles FormView3.ItemUpdated
        ShowAlert("success", "", "Rekod berjaya dikemaskini")
    End Sub

    Private Sub FormView4_ItemUpdated(sender As Object, e As FormViewUpdatedEventArgs) Handles FormView4.ItemUpdated
        ShowAlert("success", "", "Rekod berjaya dikemaskini")
    End Sub

    Private Sub FormView5_ItemUpdated(sender As Object, e As FormViewUpdatedEventArgs) Handles FormView5.ItemUpdated
        ShowAlert("success", "", "Rekod berjaya dikemaskini")
    End Sub
